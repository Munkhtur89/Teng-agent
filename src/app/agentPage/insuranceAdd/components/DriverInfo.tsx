...
const DriverInfo: React.FC<DriverInfoProps> = ({
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-0 bg-[#0066D9] rounded-2xl overflow-hidden border border-[#3388e0] max-w-xl">
            <input
              ...
              placeholder="Регистрийн дугаар эсвэл нэрээр хайх..."
          ...
          {formData.product === "425" || formData.product === "426" ? (
            <div>
              ...
              <input
                ...
                onChange={handleCurrentDriverChange}
                className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 hover:border-gray-400"
                placeholder="Гадаад паспортын дугаар"
              />
            </div>
          ) : (
            <div>
              ...
              <input
                type="text"
                name="driverAddress"
                value={currentDriver.driverAddress || ""}
                onChange={handleCurrentDriverChange}
                className="w-full border-2 border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 hover:border-gray-400"
                placeholder="Хаяг"
              />
      ...
      {/* {relatedPartners.map((partner, idx) => (
          <div key={idx}>
            <input
              value={partner.lastname}
              onChange={(e) =>
                handlePartnerChange(idx, "lastname", e.target.value)
              }
              placeholder="Овог"
            />
            <input
              ...
              onChange={(e) =>
                handlePartnerChange(idx, "firstname", e.target.value)
              }
              placeholder="Нэр"
            />
            <input
              value={partner.register_number}
              onChange={(e) =>
                handlePartnerChange(idx, "register_number", e.target.value)
              }
              placeholder="РД"
            />
            <input
              value={partner.passport_number}
              onChange={(e) =>
                handlePartnerChange(idx, "passport_number", e.target.value)
              }
              placeholder="Паспорт"
            />
          </div>
